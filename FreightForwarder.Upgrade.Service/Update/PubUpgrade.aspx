<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PubUpgrade.aspx.cs" Inherits="FreightForwarder.Upgrade.Service.PubUpgrade" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="upgrade-list">
            ...
            <asp:SqlDataSource ID="ssUpgrade" runat="server"
                 ConnectionString="<%$ ConnectionStrings:FFDB %>"
                 SelectCommand="select * from UpgradePackages">
            </asp:SqlDataSource>
        </div>
    </form>
</body>
